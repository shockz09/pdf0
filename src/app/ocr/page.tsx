							...
							logger: (m) => {
								if (m.status === "recognizing text") {
									...
									const overallProgress =
										30 +
										((i + pageProgress / 100) / imagesToProcess.length) * 70;
			...
			{!file ? (
							...
							<div className="success-card">
								...
								<div className="space-y-2 mb-8">
									...
									<p className="text-sm text-muted-foreground">
										File size: {(searchablePdf.length / 1024 / 1024).toFixed(2)}{" "}
										MB
									</p>
								</div>
                ...
                `}
							>
								...
								<div
									className={`text-xs font-normal mt-1 ${mode === "searchable" ? "text-white/80" : "text-muted-foreground"}`}
								>
                ...
                `}
							>
								...
								<div
									className={`text-xs font-normal mt-1 ${mode === "extract" ? "text-white/80" : "text-muted-foreground"}`}
								>
					...
					<div className="info-box">
						...
						<div className="text-sm space-y-1">
							...
							<ul className="list-disc list-inside text-muted-foreground space-y-0.5">
								...
								<li>
									Searchable PDF keeps the original look but adds selectable
									text
								</li>
